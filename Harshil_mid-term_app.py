...
@app.route("/")
def index():
    return "Hello World! Mid-Term Flask App by Harshil Shah to compare a " \
           "stock's performance with S&P 500 for calendar year 2016"
...
def query_example():
    ...
    return '''<h1>The language value is: {}</h1>
              ...
              <h1>The website value is: {}'''.format(language, framework,
                                                     website)
